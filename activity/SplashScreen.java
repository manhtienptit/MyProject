...
import com.seatgeek.placesautocompletedemo.util.AndroidUtil;
...
//                editor.putString("LATITUDE", "21.017646");
//                editor.putString("LONGITUDE", "105.782319");
//                editor.putString("RADIUS", "1000");
                editor.commit();
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(SplashScreen.this, ColorActivity.class);
                        startActivity(i);
