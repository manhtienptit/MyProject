...
import com.seatgeek.placesautocompletedemo.helper.CircleTransform;
import com.seatgeek.placesautocompletedemo.helper.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.from.setText(message.getIdUser());
        holder.subject.setText(message.getTxtTitle());
        holder.message.setText(message.getTxtCmt());
        holder.timestamp.setText(message.getDatatime());
